            ...
            <div class="top-navbar style-1">
                <div class="container p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <a href="#" class="logo-brand d-none d-lg-flex align-items-center" style="gap: 8px;">
                                <img src="assets/img/logoBeritain.png" alt="Logo Dark" class="dark-none"
                                    style="height: 32px;">
                                <img src="assets/img/logoBeritain.png" alt="Logo Light" class="light-none"
                                    style="height: 32px;">
                                <span style="color: red; font-weight: bold; font-size: 18px;">Berita'in</span>
                            </a>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="container p-0">
                    <div class="mob-nav-toggles d-flex align-items-center justify-content-between">
                        ...
                        <a href="#" class="logo-brand d-block d-lg-none w-50 my-4">
                            <img src="assets/img/logoBeritain.png" alt="" class="dark-none">
                            <img src="assets/img/logoBeritain.png" alt="" class="light-none">
                        </a>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdownMenu" aria-labelledby="navbarDropdown1">
                                    ...
                                    <li><a class="dropdown-item" href="page-author-details.html">author details</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
        ...
        <section class="tc-main-post-style1 pb-60">
            <div class="container">
                <div class="tc-main-post-title pt-40 pb-40">
                    <div class="row">
                        <div class="col-lg-8">
                            <p class="text-uppercase mb-15">Olahraga</p>
                            <h2 class="title">Manny Pacquiao Pastikan Comeback Lawan Barrios: Mari Cetak Sejarah!</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="author-side color-666 fsz-13px">
                                <div class="author me-40 d-flex d-lg-inline-flex align-items-center">
                                    ...
                                    <span>By</span>
                                    <a href="#" class="text-decoration-underline text-primary ms-1">Conor
                                        Bradley</a>
                                </div>
                                <span class="me-40">
                ...
                <div class="tc-main-post-img img-cover mb-50">
                    <img src="assets/img/singlepost/main1.jpg" alt="">
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <h4 class="sub-title sm-content-width">
                                Legenda tinju dunia
                                <span class="color-main">Manny Pacquiao
                                </span> memastikan akan kembali ke ring tinju untuk menghadapi juara dunia kelas welter
                                WBC Mario Barrios.s
                            </h4>
                            <p class="info-text sm-content-width mt-40">
                                ...
                                etinju asal Filipina itu kali terakhir naik ring tinju profesional pada 2021. Saat itu
                                ia menelan kekalahan angka mutlak dari Yordenis Ugas. Sejak saat itu, Pacquiao
                                memutuskan benar-benar pensiun dan fokus pada karier politiknya. Namun, ia sempat naik
                                ring lagi di laga eksibisi melawan kickboxer Jepang, Rukiya Anpo, tahun lalu.
                            </p>
                            <h4 class="sub-title sm-content-width mt-40">
                                Sample Heading
                            </h4>
                            <h6 class="sub-title sm-content-width mt-30">
                                The first, and most obvious, is a noise when you apply the brake pedal. This could be
                                anything from a grinding sound to a high-pitched screech
                            </h6>
                            <div class="info-text-img mt-30">
                                <div class="row">
                                    <div class="col-lg-7">
                                        <p class="info-text">
                                            wearing thin and the calipers. An account of McLaren’s efforts to win her
                                            mother’s blessing for the book over a girls’ weekend in New York frames a
                                            narrative composed of chronologically arranged vignettes that capture
                                            telling moments from McLaren’s girlhood and early adulthood. More room mate
                                            than parent, Cessie gave her the freedom to cruise through school snacking
                                            on magic mushrooms, stay out all night with calling home, and tolerate the
                                            gaze of a voyeur in the alleyway outside their apartment – until she woke to
                                            find him trying to climb through her bedroom window. Listening, McLaren’s
                                            first response was relief & perhaps her own story wasn’t so momentous after
                                            all.
                                        </p>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="img img-cover th-280 mt-15">
                                            <img src="assets/img/latest/136.png" alt="">
                                        </div>
                                        <div class="text-center color-999 py-3 fst-italic">
                                            <span>Images by <a href="#"
                                                    class="color-000">@tim_arterbury</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <p class="info-text sm-content-width mt-30">
                                Her mother’s, on the other hand, would come to haunt her. It appeared to hold the key to
                                Cessie’s doomed marriage to McLaren’s small-town father at 21 and her flight, a dozen
                                years later, in pursuit of urban sophistication and a career in newspapers. It explained
                                a tortured romance that saw <a href="#"
                                    class="text-decoration-underline text-primary">Text link</a> from one emotional
                                    ...
                                    <div class="col-lg-7">
                                        <div class="quote-message">
                                            ...
                                            <div class="info">
                                                ...
                                                <p class="color-999 mt-20"> <strong class="color-000"> M Moussa
                                                    </strong> // Envato Author</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="content-info">
                                            ...
                                            <p class="info-text">
                                                Sub Heading “The Horseman was both the clue and the final reveal. He was
                                                keystone in the arch, the signature at the bottom of every page. As
                                                Homer Simpson once observed of beer, the Horseman was the cause of and
                                                solution to all of life’s problems,” explains McLaren. It could only be
                                                a matter of time before someone in this family of writers (the mother
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-10 offset-lg-2">
                                        <p class="info-text ps-30">
                                            of author and uncle are both journalists). It explained a tortured romance
                                            that saw Cessie lurch from one emotional crisis to another throughout
                                            McLaren’s adolescence
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="content border-1 border-top border-bottom brd-gray pt-50 pb-50">
                            <a href="#" class="d-block img-cover">
                                <img src="assets/img/banner18.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="tc-main-post-content">
                            ...
                            <p class="info-text">
                                The first and most obvious, is a noise when <span class="fst-italic">“you apply the
                                    brake pedal”</span>. This could be anything from a grinding sound to a high-pitched
                                screech
                            </p>
                            <ul class="info-text mt-40 mb-40">
                                <li> Welsh novelist Sarah Waters sums it up eloquently </li>
                                <li>In their classic book, Creativity in Business, based on a popular course tvhey
                                    co-taught</li>
                                <li>Novelist and screenwriter Steven Pressfield</li>
                            </ul>
                            <p class="info-text">
                                That immediately brought to mind one of <a href="#"
                                    class="text-decoration-underline text-cyan">my fondest</a> memories, involving my
                                daughter
                            </p>
                            ...
                            <p class="info-text mt-50">
                                ...
                                determination and passion to deliver high-impact global reporting, always free from
                                ...
                                <div class="row justify-content-around align-items-center">
                                    <div class="col-lg-4">
                                        <div class="sub-info">
                                            ...
                                            <p class="fsz-13px color-666">Subscribe our newsletter to get latest news &
                                                promotion</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="sub-form mt-4 mt-lg-0">
                                            ...
                                            <p class="mt-2 color-666 fsz-13px fst-italic">By subscribing, you accepted
                                                the our <a href="#"
                                                    class="text-decoration-underline fst-normal color-000">Policy</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p class="info-text mt-50">
                                Our should never complain, complaining is a weak emotion, you gotlife, we breathing, we
                                blessed. Surround yourself with angels. They never said winning was easy
                            </p>
                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="#" class="item">
                                            ...
                                            <h6 class="title">PFF: Bills should consider free agent CB Xavier Rhodes
                                            </h6>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                    ...
                    <div class="content mt-50 p-50 d-block d-lg-flex bg-gray1">
                        ...
                        <div class="info">
                            ...
                            <div class="text fsz-15px color-666 mt-20">
                                ...
                                mollit anim id est laborum sed ut perspiciatis unde. Lorem ispum dolor sit amet
                                prodigues ametalia
                            </div>
                ...
                <div class="content pt-50 pb-50 border-1 border-top border-dark">
                    <div class="row">
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <a href="page-blog.html" class="color-000 text-uppercase mb-30 ltspc-1"> more from this
                                author <i class="la la-angle-right ms-1"></i> </a>
                            <div class="row">
                                <div class="col-12 border-1 border-end brd-gray">
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="assets/img/another_news/1.png" alt="">
                                            </div>
                                            <div class="content pt-20">
                                                ...
                                                <div class="meta-bot lh-1 mt-20">
                                                    <ul class="d-flex">
                                                        <li class="date me-5">
                                                            <a href="#"><i class="la la-calendar me-2"></i> Dec
                                                                14,
                                                                2022</a>
                                                        </li>
                                                        <li class="comment">
                                        ...
                                        <div class="items">
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/another_news/2.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html"
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/another_news/3.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <a href="page-blog.html" class="color-000 text-uppercase mb-30 ltspc-1"> related posts <i
                            ...
                            <div class="row">
                                <div class="col-12 border-1 border-end brd-gray">
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="assets/img/latest/124.png" alt="">
                                            </div>
                                            <div class="content pt-20">
                                                <a href="#"
                                                    class="news-cat color-999 fsz-13px text-uppercase mb-10">sport</a>
                                        ...
                                        <div class="items">
                                            <a href="page-single-post-creative.html"
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/latest/123.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html"
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/latest/130.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                        ...
                        <div class="col-lg-4">
                            <a href="page-blog.html" class="color-000 text-uppercase mb-30 ltspc-1"> recommended <i
                                    class="la la-angle-right ms-1"></i> </a>
                            <div class="row">
                                <div class="col-12">
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="assets/img/latest/137.png" alt="">
                                            </div>
                                            <div class="content pt-20">
                                                <a href="#"
                                        ...
                                        <div class="items">
                                            <a href="page-single-post-creative.html"
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/latest/132.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html"
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="assets/img/latest/131.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group mb-30">
                                                <textarea class="form-control rounded-0 fsz-12px p-3" name="comment" rows="6"
    ...
    <footer class="footer-style1">
        <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="sub-form">
                            ...
                            <p class="mt-2 color-666 fsz-13px fst-italic">By subscribing, you accepted the our <a
                                    href="#" class="text-decoration-underline fst-normal color-000">Policy</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gx-lg-5">
                    ...
                    <div class="col-lg-2">
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Startup</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Business Trends</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Work Culture</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Personal Finance</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Leaders</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Stocks Market</a>
                                </li>
                            </ul>
                        </div>
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Capital Journal</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">National Security</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Politics Video</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Personal Technology</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Product Reviews</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Video Games</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Discover</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Knowledge</a>
                                </li>
                            </ul>
                        </div>
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Lifestyle Trends</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Family</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Psychology</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Fashion</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Foods</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Culture</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Music & Podcasts</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Art & Design</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Movies</a>
                                </li>
                            </ul>
                        </div>
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Football</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Tennis</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">F-1 Racing Tour</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">NBA</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Basketball</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="link-group">
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="f-link">Discovery</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Flight Tickets & Hotel</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Tour</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Destination</a>
                                </li>
                                <li>
                                    <a href="#" class="f-link">Experience & Reviews</a>
                                </li>
                            </ul>
                        </div>
                        <div class="link-group">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#" class="f-link">Partners Programe</a>
                                </li>
                                <li>
            ...
            <div class="foot text-center py-4 border-1 border-top brd-gray">
                <p class="fsz-13px color-666">© 2023 Copyrights by <a href="#" class="color-000">Newzin</a>.
                    All Rights
                    Reserved. Developed by <a href="#"
